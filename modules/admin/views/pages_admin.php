...
<script type='text/javascript'>		
	...
	********/
	...
	var edit_bloger = function (v_id) {				
	    ...
	    if(v_id > 0){		    	
		    editPostForm.form.load({url:'/admin/pages/edit_news',
		        params:{
		            id:v_id
		        },
		        waitMsg:'Очікуйте...',
		        success:function(response){		        	
		        	...
		        	var img_link= '/upload/pages/m_'+v_id+'.jpg';
    ...
    var itemsStore = new Ext.data.Store({
        ...
        reader:new Ext.data.JsonReader({
            ...
            totalProperty:'total',
            id:'id'
        },["id","title" ,"created_at", "important",'show_on_main','seo_name']),
        remoteSort:true 
    });
    ...
    var itemsGrid = new Ext.grid.EditorGridPanel({
        ...
        tbar:[{
            ...
            iconCls:'save',
            handler:function(){
            	itemsSave(itemsStore, '/admin/pages/save_grid');
            ...
            iconCls:'remove',
            handler:function(){
            	itemsRemove(itemsGrid, '/admin/pages/remove_news');
