...
class Volonters_Admin extends Constructor
{
    ...
    protected $where_statement = "id IN (Select user_id FROM roles_users Where role_id=3)";
    ...
    protected function _todb(&$data, $id = FALSE)
    {
        ...
        $data['password'] = $auth->hash_password($password1, $salt);
            ...
            $user->add(ORM::factory('role', 'volonter'));
            $user->save();
        }
