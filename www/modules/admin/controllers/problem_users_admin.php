...
class Problem_Users_Admin extends Constructor
{
    ...
    protected $where_statement = "id IN (Select user_id FROM roles_users Where role_id=5)";
    ...
    protected $grid_columns = array(
    	...
    	"site",
    	"about",
        "(Select Count(id) From problems where daddy.id= user_id) as p_count"
    ...
    protected function _todb(&$data, $id = FALSE)
    {
        ...
        $data['password'] = $auth->hash_password($password1, $salt);
            ...
            $user->add(ORM::factory('role', 'problems'));
            $user->save();
        }
