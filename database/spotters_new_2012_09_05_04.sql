...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`spotters_new` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
insert  into `airports`(`id`,`status`,`IATA`,`ICAO`,`city_id`,`latitude`,`longitude`,`countries_id`) values (5,1,'ADT','ACUT',10,NULL,NULL,12),(6,1,'ASR','FGTE',12,NULL,NULL,14);
...
insert  into `airports_langs`(`id`,`name`,`id_lang`,`airports_id`) values (22,'Борисполь',0,5),(23,'Бориспіль',1,5),(24,'Borispol',2,5),(25,'Домодедово',0,6),(26,'Домодедово',1,6),(27,'Domodedovo',2,6);
...
insert  into `cities`(`id`,`status`,`countries_id`) values (10,1,12),(12,1,14);
...
insert  into `countries_langs`(`id`,`id_lang`,`name`,`countries_id`) values (40,0,'Украина',12),(41,1,'Украина',12),(42,2,'Ukraine',12),(43,0,'Россия',14),(44,1,'Росія',14),(45,2,'Russia',14);
...
insert  into `news`(`id`,`status`,`type`,`user_id`,`date`,`views_count`) values (1,1,'telegraph',1,'2012-09-06',0),(2,1,'telegraph',1,'2012-09-07',0),(3,1,'telegraph',1,'2012-09-10',0),(4,1,'base',1,'2012-09-10',0),(5,1,'base',1,'2012-09-14',0),(6,1,'base',1,'2012-09-18',0),(7,1,'base',1,'2012-09-24',0),(8,1,'base',1,'2012-09-20',0),(9,1,'telegraph',1,'2012-09-11',0),(10,1,'telegraph',1,'2012-09-15',0),(11,1,'telegraph',1,'2012-09-17',0),(12,1,'telegraph',1,'2012-09-18',0);
...
insert  into `news_langs`(`id`,`title`,`meta_desc`,`meta_keywords`,`seo_name`,`text`,`news_id`,`id_lang`) values (1,'Title_1','Title 1','Title 1','Title_1','Title_1 dsfdsafdsafd',1,0),(2,'Title_2','Title_2','Title_2','Title_2','Title_2 df dsdsafdasfdas',2,0),(3,'Title 3','Title_3','Title_3','Title_3','Title_3 dsfdsaf adas',3,0),(4,'Title 1 en','Title_1 en',NULL,NULL,'Title_1 en dafd asfdsa ',1,1),(5,'Title 4',NULL,NULL,'Title 4','Title 4 dfa dfadsfea',4,0),(6,'Title 5',NULL,NULL,'Title 5','Title 5 dfa dfadsfea',5,0),(7,'Title 6',NULL,NULL,'Title 6','Title 6 dfa dfadsfea',6,0),(8,'Title 7',NULL,NULL,'Title 7','Title 7 dfa dfadsfea',7,0),(9,'Title 8',NULL,NULL,'Title 8','Title 8 dfa dfadsfea',8,0),(10,'Title 9',NULL,NULL,'Title 9','Title 9 dfa dfadsfea',9,0),(11,'Title 10',NULL,NULL,'Title 10','Title 10 dfa dfadsfea',10,0),(12,'Title 11',NULL,NULL,'Title 11','Title 11 dfa dfadsfea',11,0);
...
insert  into `pictures`(`id`,`name`,`type`,`post_id`) values (7,'alboms_photo_04.jpg','photo',1),(8,'alboms_photo_01.jpg','photo',2),(9,'alboms_photo_01.jpg','photo',44),(10,'alboms_photo_04.jpg','photo',45),(11,'alboms_photo_01.jpg','photo',46),(12,'alboms_photo_04.jpg','photo',47),(13,'alboms_photo_01.jpg','photo',48),(14,'alboms_photo_04.jpg','photo',49),(15,'alboms_photo_01.jpg','photo',50),(16,'alboms_photo_04.jpg','photo',51),(17,'alboms_photo_01.jpg','photo',52),(18,'alboms_photo_04.jpg','photo',53),(19,'alboms_photo_01.jpg','photo',54),(20,'alboms_photo_04.jpg','photo',55),(21,'alboms_photo_01.jpg','photo',56),(22,'alboms_photo_04.jpg','photo',3);
...
insert  into `plane_modifications`(`id`,`name`,`plane_types_id`,`manufacturers_id`) values (6,'-',7,3),(7,'a',7,3);
...
insert  into `plane_types`(`id`,`name`,`manufacturers_id`) values (7,'120',3);
...
insert  into `planes`(`id`,`name`,`status`,`companies_id`,`manufacturers_id`,`plane_types_id`,`plane_modifications_id`) values (4,'Dsa',1,4,3,7,7),(5,'Plane_1',1,2,3,7,6);
...
CREATE TABLE `posts` (
  ...
  CONSTRAINT `posts_ibfk_2` FOREIGN KEY (`plane_id`) REFERENCES `planes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

/*Data for the table `posts` */

insert  into `posts`(`id`,`serial_number`,`description`,`date`,`created_at`,`countries_id`,`plane_id`,`tech_type_id`,`rating`,`type`,`reg_code`,`views_count`,`company_id`,`user_id`,`airport_id`) values (1,'cn 2912','Впервые в Одессе - А-321 ! Длинная \"колбаса\" однако ) В этот раз солнце было менее благосклонно к нам, низкая облачность и дымка стелились прям по ВПП. Получилось как то так. 3-ий борт SSJ Арофлота все стоит.','2012-09-04','2012-09-12 12:19:00',12,5,1,4.6,'photo','VP-BQS',123,2,1,5),(2,'cn 2912','Впервые в Одессе - А-321 ! Длинная \"колбаса\" однако ) В этот раз солнце было менее благосклонно к нам, низкая облачность и дымка стелились прям по ВПП. Получилось как то так. 3-ий борт SSJ Арофлота все стоит.','2012-09-06','2012-09-15 17:51:12',12,5,1,4.8,'photo','VP-BQS',321,2,1,5),(3,'cn 2912','Впервые в Одессе - А-321 ! Длинная \"колбаса\" однако ) В этот раз солнце было менее благосклонно к нам, низкая облачность и дымка стелились прям по ВПП. Получилось как то так. 3-ий борт SSJ Арофлота все стоит.','2012-09-19','2012-09-04 14:48:03',12,4,1,0.333,'photo','VP-BQS',1,2,1,5),(44,'cn 2912','Впервые в Одессе - А-321 ! Длинная \"колбаса\" однако ) В этот раз солнце было менее благосклонно к нам, низкая облачность и дымка стелились прям по ВПП. Получилось как то так. 3-ий борт SSJ Арофлота все стоит.','2012-09-19','2012-09-04 14:48:03',12,4,1,0.333,'photo','VP-BQS',1,2,1,5),(45,'cn 2912','Впервые в Одессе - А-321 ! Длинная \"колбаса\" однако ) В этот раз солнце было менее благосклонно к нам, низкая облачность и дымка стелились прям по ВПП. Получилось как то так. 3-ий борт SSJ Арофлота все стоит.','2012-09-19','2012-09-04 14:48:03',12,4,1,0.333,'photo','VP-BQS',1,2,1,5),(46,'cn 2912','Впервые в Одессе - А-321 ! Длинная \"колбаса\" однако ) В этот раз солнце было менее благосклонно к нам, низкая облачность и дымка стелились прям по ВПП. Получилось как то так. 3-ий борт SSJ Арофлота все стоит.','2012-09-19','2012-09-04 14:48:03',12,4,1,0.333,'photo','VP-BQS',1,2,1,5),(47,'cn 2912','Впервые в Одессе - А-321 ! Длинная \"колбаса\" однако ) В этот раз солнце было менее благосклонно к нам, низкая облачность и дымка стелились прям по ВПП. Получилось как то так. 3-ий борт SSJ Арофлота все стоит.','2012-09-19','2012-09-04 14:48:03',12,4,1,0.333,'photo','VP-BQS',1,2,1,5),(48,'cn 2912','Впервые в Одессе - А-321 ! Длинная \"колбаса\" однако ) В этот раз солнце было менее благосклонно к нам, низкая облачность и дымка стелились прям по ВПП. Получилось как то так. 3-ий борт SSJ Арофлота все стоит.','2012-09-19','2012-09-04 14:48:03',12,4,1,0.333,'photo','VP-BQS',1,2,1,5),(49,'cn 2912','Впервые в Одессе - А-321 ! Длинная \"колбаса\" однако ) В этот раз солнце было менее благосклонно к нам, низкая облачность и дымка стелились прям по ВПП. Получилось как то так. 3-ий борт SSJ Арофлота все стоит.','2012-09-19','2012-09-04 14:48:03',12,4,1,0.333,'photo','VP-BQS',1,2,1,5),(50,'cn 2912','Впервые в Одессе - А-321 ! Длинная \"колбаса\" однако ) В этот раз солнце было менее благосклонно к нам, низкая облачность и дымка стелились прям по ВПП. Получилось как то так. 3-ий борт SSJ Арофлота все стоит.','2012-09-19','2012-09-04 14:48:03',12,4,1,0.333,'photo','VP-BQS',1,2,1,5),(51,'cn 2912','Впервые в Одессе - А-321 ! Длинная \"колбаса\" однако ) В этот раз солнце было менее благосклонно к нам, низкая облачность и дымка стелились прям по ВПП. Получилось как то так. 3-ий борт SSJ Арофлота все стоит.','2012-09-19','2012-09-04 14:48:03',12,4,1,0.333,'photo','VP-BQS',1,2,1,5),(52,'cn 2912','Впервые в Одессе - А-321 ! Длинная \"колбаса\" однако ) В этот раз солнце было менее благосклонно к нам, низкая облачность и дымка стелились прям по ВПП. Получилось как то так. 3-ий борт SSJ Арофлота все стоит.','2012-09-19','2012-09-04 14:48:03',12,4,1,0.333,'photo','VP-BQS',1,2,1,5),(53,'cn 2912','Впервые в Одессе - А-321 ! Длинная \"колбаса\" однако ) В этот раз солнце было менее благосклонно к нам, низкая облачность и дымка стелились прям по ВПП. Получилось как то так. 3-ий борт SSJ Арофлота все стоит.','2012-09-19','2012-09-04 14:48:03',12,4,1,0.333,'photo','VP-BQS',1,2,1,5),(54,'cn 2912','Впервые в Одессе - А-321 ! Длинная \"колбаса\" однако ) В этот раз солнце было менее благосклонно к нам, низкая облачность и дымка стелились прям по ВПП. Получилось как то так. 3-ий борт SSJ Арофлота все стоит.','2012-09-19','2012-09-04 14:48:03',12,4,1,0.333,'photo','VP-BQS',1,2,1,5),(55,'cn 2912','Впервые в Одессе - А-321 ! Длинная \"колбаса\" однако ) В этот раз солнце было менее благосклонно к нам, низкая облачность и дымка стелились прям по ВПП. Получилось как то так. 3-ий борт SSJ Арофлота все стоит.','2012-09-19','2012-09-04 14:48:03',12,4,1,0.333,'photo','VP-BQS',1,2,1,5),(56,'cn 2912','Впервые в Одессе - А-321 ! Длинная \"колбаса\" однако ) В этот раз солнце было менее благосклонно к нам, низкая облачность и дымка стелились прям по ВПП. Получилось как то так. 3-ий борт SSJ Арофлота все стоит.','2012-09-19','2012-09-04 14:48:03',12,4,1,0.333,'photo','VP-BQS',1,2,1,5);
...
insert  into `tech_types_langs`(`id`,`id_lang`,`name`,`tech_type_id`) values (1,0,0,1),(2,0,0,2),(3,0,0,3);
